        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BillDocuments_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CashFlowReports", x => x.ReportId);
                    table.ForeignKey(
                        name: "FK_CashFlowReports_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FinanceForecasts", x => x.ForecastId);
                    table.ForeignKey(
                        name: "FK_FinanceForecasts_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InterestCalculations", x => x.CalculationId);
                    table.ForeignKey(
                        name: "FK_InterestCalculations_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CashFlowReports_UserId",
                table: "CashFlowReports",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_FinanceForecasts_UserId",
                table: "FinanceForecasts",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InterestCalculations_UserId",
                table: "InterestCalculations",
                column: "UserId");
